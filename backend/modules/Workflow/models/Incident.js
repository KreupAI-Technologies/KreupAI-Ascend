...
const incidentSchema = new Schema({
    ...
    lead_id: { type: Schema.Types.ObjectId, ref: 'Lead', required: true }, // Reference to Leads
    assigned_to: { type: Schema.Types.ObjectId, ref: 'User', required: true }, // Reference to Users
