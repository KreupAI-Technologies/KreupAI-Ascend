...
const DealsActionBar = ({ onFormSubmit }) => {
  ...
  return (
    <div>
      ...
      <Modal isOpen={isModalOpen} closeModal={closeModal} title="Create Deal">
        <DealsForm closeModal={closeModal} onSubmit={onFormSubmit} />
      </Modal>
